...
<figure align="center">
  <img src="docker-registry.svg" alt="Docker registries build > share > run pipeline">
...
<figure align="center">
  <img src="docker-fully-qualified-image-name.svg" alt="Docker fully qualified image name">
...
<figure align="center">
  <img src="docker-image-stacked-layers.svg" alt="Docker image stacked layers">
...
1. During docker pull:  
    ...
    <figure align="center">
      <img src="docker-image-stacked-layers-ubuntu.svg" alt="Docker image stacked layers with IDs">
...
<figure align="center">
  <img src="docker-simplified-layer-image.svg" alt="Diagram showing a base layer with subsequent layers added on top to form a Docker image">
...
<figure align="center">
  <img src="docker-stacking-layers-files.svg" alt="Diagram showing File 4 in a lower layer being obscured by File 6 (same path) in an upper layer.">
